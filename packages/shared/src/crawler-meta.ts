...
export const CRAWLER_META: readonly CrawlerMeta[] = [
  ...
  { slug: "zoho",         name: "Zoho",         kind: "html-dom", adaptive: true,  hasFixture: false },
  ...
  { slug: "chargebee",    name: "Chargebee",    kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "meesho",       name: "Meesho",       kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "nykaa",        name: "Nykaa",        kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "dream11",      name: "Dream11",      kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "policybazaar", name: "PolicyBazaar", kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "lenskart",     name: "Lenskart",     kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "udaan",        name: "Udaan",        kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "delhivery",    name: "Delhivery",    kind: "api",      adaptive: true,  hasFixture: false },
  // ─── Tier 3 — emerging & solid product cos ──────────────────────────────
  // inmobi (Greenhouse), unacademy (SmartRecruiters), cars24 (SmartRecruiters) wired.
  { slug: "sharechat",    name: "ShareChat",    kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "ola",          name: "Ola",          kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "paytm",        name: "Paytm",        kind: "api",      adaptive: true,  hasFixture: false },
  ...
  { slug: "myntra",       name: "Myntra",       kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "practo",       name: "Practo",       kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "pine-labs",    name: "Pine Labs",    kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "nobroker",     name: "NoBroker",     kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "wingify",      name: "Wingify",      kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "clevertap",    name: "CleverTap",    kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "moengage",     name: "MoEngage",     kind: "html-dom", adaptive: true,  hasFixture: false },
  { slug: "yellow-ai",    name: "Yellow.ai",    kind: "api",      adaptive: true,  hasFixture: false },
  { slug: "arcesium",     name: "Arcesium",     kind: "api",      adaptive: true,  hasFixture: false },
] as const;
