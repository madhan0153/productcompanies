...
export const PILLAR_GUIDES: readonly PillarGuide[] = [
  {
    ...
    description:
      "Step-by-step playbook for getting hired at India's 51 top product companies — resume positioning, target roles, interview prep, and the application path. Field-tested by ProdMatch's matching engine.",
  ...
  },
  {
    ...
    description:
      "Application playbook for fresh graduates targeting India's product-based companies. Which companies hire freshers, what the SDE-1 / Associate loop looks like, comp bands, and a realistic 6-month prep plan from college to offer.",
