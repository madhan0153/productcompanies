// Sprint 6 — Compact "evidence" panel for the job detail page.
// Pulls together the four new signals (confidence, hard cap, tech coverage,
// feedback delta) into one explainability card. Sits between the Fit Card
// and the Apply Toolkit on /jobs/[id].
//
// Renders only what's populated — older matches (pre-Sprint-6) with all
// new columns NULL produce nothing, so the page stays clean.
      ...
      {tc && (
        <div className="mb-2">
          <div className="mb-2 flex items-center gap-1.5 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground">
            ...
            Tech coverage vs JD must-haves
          </div>
